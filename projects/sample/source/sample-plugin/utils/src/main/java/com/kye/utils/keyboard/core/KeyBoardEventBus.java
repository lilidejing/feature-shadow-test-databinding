...
import com.kye.utils.keyboard.callback.GlobalLayoutListenerImp;
...
/**
 * 用于管理键盘事件,监听键盘的显示隐藏，用例参见 com.kye.pad.business.login.v2.LoginActivity
 *
 * @author Simon
 */
public final class KeyBoardEventBus {
     ...
     * 设置不覆盖的view
     * */
    public void setTargetView(Object object, View targetView){
        Activity activity = getActivity(object);
        if (activity == null) {
            return;
        }
