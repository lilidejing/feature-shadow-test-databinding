...
/**
 * Routing
 * Desc    Glide图片加载框架二次封装
 * Source  https://github.com/Shimingli/ImageLoader
 * Created shiming on 2016/10/26.
 * Modify  by yangwentao on 2018/7/9 16:54
 * Version 1.0
 */
...
public class ImageLoaderV4 implements IImageLoaderClient {
    ...
    public void displayRoundImageWithNoCache(Context context, String url, ImageView imageView,
        ...
        if (client != null) {
            client.displayRoundImageWithNoCache(context, url, imageView, defRes, radius);
        }
    }
    ...
    public void displayRotateImage(Context context, String path, ImageView imageView, float radius) {
        if (client != null) {
            client.displayRotateImage(context, path, imageView, radius);
        }
    }
