package com.kye.utils.imageloader.okhttp;
...
public class ProgressManager {
    ...
    private static final List<WeakReference<OnProgressListener>> listeners = Collections.synchronizedList(new ArrayList<WeakReference<OnProgressListener>>());
